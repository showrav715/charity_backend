...
class LanguageController extends Controller
{
    ...
    {
        $request->validate(['name' => 'required|max:25|unique:languages,language', 'code' => 'required|unique:languages|size:2']);
    ...
    {
        $request->validate(['name' => 'required|max:25|unique:languages,language,' . $language->id, 'code' => 'required|unique:languages,code,' . $language->id . '|size:2']);
