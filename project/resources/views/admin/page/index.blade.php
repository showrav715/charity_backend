...
@section('breadcrumb')
    <section class="section">
        <div class="section-header d-flex justify-content-between">
            ...
            <a href="{{ route('admin.page.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> @lang('Create New')
            </a>
        </div>
    </section>
@endsection
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Actions')">
                                    <div class="d-flex gap-10 justify-content-end">
                                        <a href="{{ route('admin.page.edit', $info) }}" class="btn btn-primary btn-sm mb-1"
                                            data-toggle="tooltip" title="@lang('Edit')"><i class="fas fa-edit"></i></a>

                                        @if ($info->slug != 'about')
                                            <a href="javascript:void(0)" class="btn btn-danger btn-sm remove mb-1"
                                                data-id="{{ $info->id }}" data-toggle="tooltip"
