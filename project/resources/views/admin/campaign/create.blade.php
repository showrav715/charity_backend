        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.campaign.store')}}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                        <label class="mt-2">
                            <input type="checkbox" name="is_faq" class="custom-switch-input" id="campaign_faq_checkbox">
                    ...
                    <div class="form-group">
                        <label class="mt-2">
                            <input type="checkbox" name="is_preloaded" class="custom-switch-input" id="allow_preloaded">
                            <span class="custom-switch-indicator"></span>
