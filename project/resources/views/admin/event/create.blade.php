        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Add New Event Form') }}</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.event.store') }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" id="title" required
                                        placeholder="{{ __('Event Title') }}" value="{{ old('title') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="date" id="date" required
                                        placeholder="{{ __('Date') }}" value="{{ old('date') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" step="any" class="form-control" name="map_link" id="map_link"
                                placeholder="{{ __('Google Map Link') }}" value="{{ old('map_link') }}">
                        </div>
